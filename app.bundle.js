...
// Tooltip
function Tooltip({ text, refUrl }) {
  return (
    React.createElement("span", { className: "relative group cursor-pointer ml-1" },
      React.createElement("span", { className: "text-blue-200" }, "ℹ️"),
      React.createElement("span", {
        className: "absolute z-10 left-1/2 -translate-x-1/2 mt-2 w-64 p-2 bg-gray-700 border border-gray-400 rounded shadow-lg text-xs text-white opacity-0 group-hover:opacity-100 transition pointer-events-none"
      },
        text,
        refUrl && React.createElement("div", { className: "mt-1" },
          React.createElement("a", { href: refUrl, target: "_blank", rel: "noopener noreferrer", className: "text-blue-200 underline" }, "Ver referência")
        )
      )
    )
  );
  ...
  return (
    React.createElement("label", { className: "flex flex-col mb-2" },
      React.createElement("span", { className: "flex items-center font-medium text-white" },
        label,
        showInfo && tooltip && React.createElement(Tooltip, { text: tooltip, refUrl: refUrl })
      ),
  ...
  return (
    React.createElement("div", { className: "mb-2" },
      React.createElement("label", { className: "font-medium flex items-center text-white" },
        "Tipo de leite",
        React.createElement(Tooltip, { text: "Escolha o tipo de leite. O coeficiente calórico está ao lado.", refUrl: "" })
      ),
  ...
  return (
    React.createElement("div", { className: "mb-2" },
      ...
      React.createElement("div", { className: "flex gap-4 mt-1" },
        COMORBIDADES.map(c => (
          React.createElement("label", { key: c.value, className: "flex items-center gap-1" },
...
// Refatorar DiferencaFaixa para sempre mostrar o valor de referência à esquerda, e mostrar check se dentro da faixa
function DiferencaFaixa({ valor, faixa, unidade }) {
  const faixaTexto = `Faixa SBP: ${faixa.min}–${faixa.max} ${unidade}`;
  if (valor < faixa.min) {
    return React.createElement(
      "span",
      { className: "inline-flex items-center ml-2" },
      React.createElement("span", { className: "text-blue-200 text-xs mr-1" }, `[${faixa.min}–${faixa.max}]`),
      React.createElement(TooltipValor, { texto: faixaTexto },
        React.createElement("span", { className: "text-red-500 font-bold" }, `${(valor - faixa.min).toFixed(2)} ${unidade}`)
      )
    );
    ...
    return React.createElement(
      ...
      React.createElement("span", { className: "text-blue-200 text-xs mr-1" }, `[${faixa.min}–${faixa.max}]`),
      React.createElement(TooltipValor, { texto: faixaTexto },
        React.createElement("span", { className: "text-green-500 font-bold" }, `+${(valor - faixa.max).toFixed(2)} ${unidade}`)
      )
    );
  } else {
    return React.createElement(
      ...
      React.createElement("span", { className: "text-blue-200 text-xs mr-1" }, `[${faixa.min}–${faixa.max}]`),
      React.createElement(TooltipValor, { texto: faixaTexto },
        React.createElement("span", { className: "text-green-500 font-bold" }, "✅")
      )
    );
  }
}
...
function GraficoComparativo({ titulo, faixa, valor, unidade }) {
  ...
  React.useEffect(() => {
    ...
    const calcBar = valor;
    const corCalc = (valor >= faixa.min && valor <= faixa.max) ? '#155C22' : (valor > faixa.max ? '#22c55e' : '#dc2626');
...
function ShareButton() {
  function handleShare() {
    if (navigator.share) {
      navigator.share({
        title: 'Calculadora Neonatal SBP',
        text: 'Veja esta calculadora neonatal da SBP!',
  ...
  return (
    React.createElement("button", {
      className: "bg-[#0C4B2E] text-white px-4 py-2 rounded shadow hover:bg-green-700 mt-4 ml-2 no-print",
      onClick: handleShare
    }, "Compartilhar")
  );
}
...
const AppBackground = () => React.createElement("div", { className: "fixed inset-0 w-screen h-screen bg-[#15202b]", style: { zIndex: -1 } });
...
function App() {
  ...
  return (
    React.createElement(React.Fragment, null,
      ...
      React.createElement("div", { className: "max-w-3xl mx-auto p-4 bg-[#15202b] text-white min-h-screen" },
        React.createElement("h1", { className: "text-2xl font-bold mb-2", style: { color: '#22c55e' } }, "Calculadora Neonatal de Cota Hídrica, Calórica e Proteíca"),
        React.createElement("div", { className: "mb-2" },
          React.createElement("span", { className: "text-sm text-gray-200" },
            ...
            React.createElement("span", { className: "text-xs text-blue-200" },
              React.createElement("a", {
                ...
                rel: "noopener noreferrer",
                className: "underline text-blue-200"
              }, "Manual deAspectos Nutricionais em Sit. Especiais na Inf. e Adolesc. - SBP 2024", React.createElement(ExternalLinkIcon, null))
            ),
            React.createElement("br", null),
            React.createElement("span", { className: "text-xs text-blue-200" },
              React.createElement("a", {
        ...
        React.createElement("div", { className: "bg-gray-500 rounded shadow p-4 text-white mt-6", id: "calc-resultados" },
          ...
          React.createElement("div", { className: "mb-2" },
            ...
            React.createElement(TooltipValor, {
              texto: `Faixa SBP: ${FAIXAS.hidrica.min}–${FAIXAS.hidrica.max} mL/kg/dia`
          ...
          React.createElement("div", { className: "mb-2" },
            ...
            React.createElement(TooltipValor, {
              texto: `Faixa SBP: ${getFaixaCalorica(comorbidades).min}–${getFaixaCalorica(comorbidades).max} kcal/kg/dia`
          ...
          React.createElement("div", { className: "mb-2" },
            ...
            React.createElement(TooltipValor, {
              texto: `Faixa SBP: ${getFaixaProteica(comorbidades).min}–${getFaixaProteica(comorbidades).max} g/kg/dia`
